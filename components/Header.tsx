...
export default function Header() {
  ...
  const getInitialTab = (): "egogift" | "event" | "cardpack" => {
  ...
  const [activeTab, setActiveTab] = useState<"egogift" | "event" | "cardpack">(getInitialTab);
  ...
  const handleMenuClick = (tab: "egogift" | "event" | "cardpack") => {
    setActiveTab(tab);
