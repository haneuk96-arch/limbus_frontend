...
export default function PersonalityEgoHubPage() {
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-yellow-300">E.G.O 등록</h1>
        <Link
      ...
      <div className="bg-[#131316] border border-red-700 rounded p-4 sm:p-6 max-w-5xl mx-auto space-y-4">
        {personalitySections.map((section) => (
          ...
          >
            <Link href={`/dante/personality/ego/${section.order}`} className="block">
