...
export default function HashtagCreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`${API_BASE_URL}/admin/keyword/tag`, {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-yellow-300">해시태그 등록</h1>
        <Link
